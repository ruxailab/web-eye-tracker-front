        ...
        <v-col>
            <v-card outlined>
                ...
                <div class="custom-outline">
                    ...
                    <Slider :value="samplePerPoint" :min="Number(10)" :max="Number(200)" label="Samples Per Point" @input="updateSamplePerPoint" />
                    <p class="help-text">More samples = better accuracy but longer calibration</p>
                    
                    <Slider :value="msPerCapture" :min="Number(20)" :step="5" :max="Number(100)"
